...
export default function PlayIcon(props) {
  return (
    <svg width="100%" height="100%" viewBox="0 0 44 44" version="1.1" {...props} className="controls__icon--play">
      ...
      <g transform="matrix(6.12323e-17,1,-1,6.12323e-17,47.526,1.72518)">
